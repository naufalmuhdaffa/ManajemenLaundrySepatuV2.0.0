...
namespace DarkModeForms
{
    public class DarkModeCS
    {
        ...
        public DarkModeCS(Form _Form, bool _ColorizeIcons = true, bool _RoundedPanels = false)
        {
            ...
            _Form.Load += (sender, e) =>
            {
                _IsDarkMode = isDarkMode(); if (ColorMode != DisplayMode.SystemDefault)
                {
        ...
        private IntPtr CustomWndProc(IntPtr hWnd, int msg, IntPtr wParam, IntPtr lParam)
        {
            ...
            {
                applyingTheme = true; _IsDarkMode = isDarkMode(); if (ColorMode != DisplayMode.SystemDefault)
                {
                    _IsDarkMode = ColorMode == DisplayMode.DarkMode;
                }
        ...
        public void ApplyTheme(bool pIsDarkMode = true)
        {
            try
            {
                ...
                if (OScolors != null)
                {
                    ...
                    if (OwnerForm != null && OwnerForm.Controls != null)
                    {
                        ...
                        OwnerForm.ControlAdded -= ownerFormControlAdded; OwnerForm.ControlAdded += ownerFormControlAdded;
                    }
            ...
            {
                DarkModeMessageBox.Show(ex.Message + ex.StackTrace, "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void ThemeControl(Control control)
        {
            ...
            control.HandleCreated -= controlHandleCreated; control.HandleCreated += controlHandleCreated;

            if (controlControlAdded == null) controlControlAdded = (sender, e) =>
            {
                ThemeControl(e.Control);
            };
            control.ControlAdded -= controlControlAdded; control.ControlAdded += controlControlAdded;
            ...
            {
                (control as ToolStripDropDown).Opening -= Tsdd_Opening; (control as ToolStripDropDown).Opening += Tsdd_Opening;
            }
            if (control is ToolStripDropDownMenu)
            {
                (control as ToolStripDropDownMenu).Opening -= Tsdd_Opening; (control as ToolStripDropDownMenu).Opening += Tsdd_Opening;
            }
            if (control is ContextMenuStrip)
            {
                ...
                (control as ContextMenuStrip).Opening -= Tsdd_Opening; (control as ContextMenuStrip).Opening += Tsdd_Opening;
            }
        ...
        public static OSThemeColors GetSystemColors(Form Window = null, int ColorMode = 0)
        {
            ...
            if (ColorMode <= 0)
            {
                _ret.Background = Color.FromArgb(32, 32, 32); _ret.BackgroundDark = Color.FromArgb(18, 18, 18);
                _ret.BackgroundLight = ControlPaint.Light(_ret.Background);

                _ret.Surface = Color.FromArgb(43, 43, 43); _ret.SurfaceLight = Color.FromArgb(50, 50, 50);
                _ret.SurfaceDark = Color.FromArgb(29, 29, 29);

                _ret.TextActive = Color.White;
                _ret.TextInactive = Color.FromArgb(176, 176, 176); _ret.TextInAccent = GetReadableColor(_ret.Accent);

                _ret.Control = Color.FromArgb(55, 55, 55); _ret.ControlDark = ControlPaint.Dark(_ret.Control);
                _ret.ControlLight = Color.FromArgb(67, 67, 67);

                _ret.Primary = Color.FromArgb(3, 218, 198); _ret.Secondary = Color.MediumSlateBlue;
            }
            ...
            if (_Control != null)
            {
                ...
                _Control.Paint += (sender, e) =>
                {
                    ...
                    if (Radius > 1)//Rounded TextBox
                    {
                        ...
                        {
                            _Control.Region = new Region(pathBorderSmooth); if (Radius > 15)
                            {
        ...
        private void Tsdd_Opening(object sender, CancelEventArgs e)
        {
            ...
            {
                toolStripMenuItem.DropDownOpening -= Tsmi_DropDownOpening; toolStripMenuItem.DropDownOpening += Tsmi_DropDownOpening;
            }
        }
        ...
        private static void ApplySystemDarkTheme(Control control = null, bool IsDarkMode = true)
        {
            /*
				 ...
				 */
            int[] DarkModeOn = IsDarkMode ? new[] { 0x01 } : new[] { 0x00 }; string Mode = IsDarkMode ? "DarkMode_Explorer" : "ClearMode_Explorer";
    ...
    public class MyRenderer : ToolStripProfessionalRenderer
    {
        ...
        protected override void OnRenderButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            Color gradientBegin = MyColors.Background; Color gradientEnd = MyColors.Background;
        ...
        protected override void OnRenderSplitButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            int Padding = 2; Size cSize = new Size(8, 4); Pen ChevronPen = new Pen(MyColors.TextInactive, 2); Point P1 = new Point(bounds.Width - (cSize.Width + Padding), (bounds.Height / 2) - (cSize.Height / 2));
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            if (_menu.Pressed)
            {
                gradientBegin = MyColors.Control; gradientEnd = MyColors.Control; DrawIt = true;
            }
            else if (_menu.Selected)
            {
                gradientBegin = MyColors.Accent; gradientEnd = MyColors.Accent; DrawIt = true;
            }
            ...
            if (e.Item.GetType().FullName == "System.Windows.Forms.MdiControlStrip+ControlBoxMenuItem")
            {
                ...
                using (Image adjustedImage = DarkModeCS.ChangeToColor(image, _ClearColor))
                {
                    ...
                    e.Graphics.CompositingQuality =
                      CompositingQuality.AssumeLinear; e.Graphics.SmoothingMode = SmoothingMode.HighQuality;
