    ...
    public static class Messenger
    {
            ...
            switch (buttons)
            {
                ...
                case MessageBoxButtons.RetryCancel:
                    ...
                    /*case MessageBoxButtons.CancelTryContinue:
						...
						form.AcceptButton = CmdButtons[2];						form.CancelButton = CmdButtons[0];						break;*/
            }
            ...
            MsgIcon Icon = 0, MessageBoxButtons buttons = MessageBoxButtons.OK, bool pIsDarkMode = true)
        {
            ...
            if (!string.IsNullOrWhiteSpace(promptText))
            {
                ...
                lblPrompt.Text = promptText; lblPrompt.AutoSize = false;
                lblPrompt.Height = 24;
            ...
            int ChangeDelayMS = 1000; int currentRow = 0;
            foreach (KeyValue field in Fields)
            {
                ...
                Contenedor.Controls.Add(field_label, 0, currentRow); if (field.ValueType == ValueTypes.Multiline)
                {
